...
<manifest>
  ...
  <project name="my-service" path="services/my-service" groups="core,backend" remote="github" revision="develop" push="fork" />
  <project name="other-svc" path="services/other-svc" />
	...
	p := m.Projects[0]
	if p.Name != "my-service" || p.Path != "services/my-service" || p.Groups != "core,backend" || p.Revision != "develop" {
